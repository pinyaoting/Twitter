...
+ (void)tweetsFromUserTimelineWithParams:(NSDictionary *)params completion:(void (^)(NSArray *tweets, NSError *error))completion {
    [[TwitterClient sharedInstance] userTimelineWithParams:params completion:completion];
}
