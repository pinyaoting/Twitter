...
- (void) initHeader {
    // profile banner
    self.header = [[ProfileHeaderView alloc] initWithFrame:CGRectMake(0, 64, self.screenWidth, 215)];
    ...
    self.finalCenterOfProfileBanner = CGPointMake(self.header.profileBannerView.center.x, 0);
